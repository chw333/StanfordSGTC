...
exp('SMG7-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/RSV/RSV-geneCounts-Normalized.txt')
...
plot('SMG7-KnockDown-UP-Yepiskoposyan.etal.exp', 'RSV-NMD-Substrates-SMG7-KnockDown.pdf')
