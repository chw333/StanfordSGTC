...
exp('UPF1SMG6SMG7-KnockDown-UP-Yepiskoposyan.etal', 'geneCounts-DelNS_M3-Normalized.txt')
...
def plot(inF, ouF):
    ...
    p.set_xlim(2,14)
    p.set_ylim(2,14)
    p.text(8, 13, 'p-value = 0.004', va='center', ha='center', fontsize=14, color='r')
    p.plot([2,14],[2,14])
    plt.title('NMD substrates normalized expression (log2)')
    plt.savefig(ouF)


plot('UPF1SMG6SMG7-KnockDown-UP-Yepiskoposyan.etal.exp', 'RSV_delNS-NMD-Substrates-UPF1SMG6SMG7-KnockDown.pdf')
