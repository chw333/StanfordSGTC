...
exp('UPF1SMG6SMG7-KnockDown-UP-Yepiskoposyan.etal', 'MERS_high_24h_geneCounts-Normalized.txt')
...
def plot(inF, ouF):
    ...
    p.set_xlim(2,14)
    p.set_ylim(2,14)
    p.text(8, 13, 'p-value = 1.37e-13', va='center', ha='center', fontsize=14, color='r')
    p.plot([2,14],[2,14])
    plt.title('NMD substrates normalized expression (log2)')
    plt.savefig(ouF)


plot('UPF1SMG6SMG7-KnockDown-UP-Yepiskoposyan.etal.exp', 'MERS_high24h-NMD-Substrates-UPF1SMG6SMG7-KnockDown.pdf')
