...
exp('SMG6-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/HCV/geneCounts-Normalized.txt')
...
plot('SMG6-KnockDown-UP-Yepiskoposyan.etal.exp', 'HCV-NMD-Substrates-SMG6-KnockDown.pdf')
