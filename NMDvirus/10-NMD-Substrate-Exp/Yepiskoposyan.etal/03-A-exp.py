...
exp('SMG6-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/KHSV/geneCounts-KHSV-Normalized.txt')
...
plot('SMG6-KnockDown-UP-Yepiskoposyan.etal.exp', 'KHSV-NMD-Substrates-SMG6-KnockDown.pdf')
