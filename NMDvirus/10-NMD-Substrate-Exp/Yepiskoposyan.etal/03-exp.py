...
exp('UPF1-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/KHSV/geneCounts-KHSV-Normalized.txt')
...
plot('UPF1-KnockDown-UP-Yepiskoposyan.etal.exp', 'KHSV-NMD-Substrates-UPF1-KnockDown.pdf')
