...
exp('SMG6-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/HIV-1/geneCounts-Normalized.txt')
...
plot('SMG6-KnockDown-UP-Yepiskoposyan.etal.exp', 'HIV-NMD-Substrates-SMG6-KnockDown.pdf')
