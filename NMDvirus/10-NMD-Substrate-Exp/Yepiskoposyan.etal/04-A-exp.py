...
exp('SMG6-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/HSV/geneCounts-HSV8h-Normalized.txt')
...
plot('SMG6-KnockDown-UP-Yepiskoposyan.etal.exp', 'HSV-NMD-Substrates-SMG6-KnockDown.pdf')
