...
exp('UPF1-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/HIV-1/geneCounts-Normalized.txt')
...
plot('UPF1-KnockDown-UP-Yepiskoposyan.etal.exp', 'HIV-NMD-Substrates-UPF1-KnockDown.pdf')
