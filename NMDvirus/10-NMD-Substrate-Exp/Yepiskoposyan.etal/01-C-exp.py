...
exp('UPF1SMG6SMG7-KnockDown-UP-Yepiskoposyan.etal', '/mnt/larsix/projects/NMD/hansun/NMDvirus/05-DESeq/RSV/RSV-geneCounts-Normalized.txt')
...
def plot(inF, ouF):
    ...
    p.set_xlim(2,14)
    p.set_ylim(2,14)
    p.text(8, 13, 'p-value = 7.55e-06', va='center', ha='center', fontsize=14, color='r')
    p.plot([2,14],[2,14])
