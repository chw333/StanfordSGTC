...
wh = grepl('MOCK|SARS_MRC5lowMOI_24hr', sampleAnnot$Sample) 
...
save(dds, rld, res, res.sig, res.sig.proteincoding, sampleAnnot, file='resSARS_low_24h.rda')

write.table( res, file="deSARS_low_24h.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
write.table( res.sig, file="deSARS_low_24h_sig.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
write.table( res.sig.proteincoding, file="deSARS_low_24h_sig_proteincoding.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
write.table( res.sig.proteincoding.up, file="deSARS_low_24h_sig_proteincoding_up.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
write.table( res.sig.proteincoding.down, file="deSARS_low_24h_sig_proteincoding_down.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
write.table( res.sig.nonproteincoding, file="deSARS_low_24h_sig_nonproteincoding.txt", quote = FALSE, sep = "\t",  row.names = T, col.names=NA)
...
write.table(cn, file="SARS_low_24h_geneCounts-Normalized.txt",quote=F,sep="\t",row.names=T,col.names=NA)
...
colnames(cn)[1]='gene_symbol'
write.table(cn, file="SARS_low_24h_geneCounts-raw.txt",quote=F,sep="\t",row.names=T,col.names=NA)
