...
dds = DESeqDataSetFromMatrix(geneCounts, sampleAnnot, design=~Individual + Condition)
dds = DESeq(dds)
res = results(dds)
...
save(dds, rld, res, res.sig, res.sig.proteincoding, sampleAnnot, file='resWNV.rda')
