...
plot('result_UPTAG_summly_n7503_S365A_TwoGTExCtrl_drug_connection',color='green')
plot('result_UPTAG_summly_n7503_S365A_TwoGTExCtrl_drug_anti-connection',color='green')
'''
