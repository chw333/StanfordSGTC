### modified for one random control from heart atrial appendage and one from heart left ventricle
READS_MIN = 100
s635a_lib =  1
cp1_lib =  1
cp2_lib = 1

inFile = open('GTEx_Heart_S635A_TwoCtrl_exp-Normalized_RandomControl.txt')
