...
###don't show drug name
drugname = ['drug#1','drug#2','drug#3','drug#4','drug#5']

cm.ax_heatmap.text(4.5, 17.2, drugname[0], ha='center')
cm.ax_heatmap.text(11.5, 17.2,drugname[1] , ha='center')
cm.ax_heatmap.text(18.5, 17.2,drugname[2] , ha='center')
cm.ax_heatmap.text(25.5, 17.2, drugname[3], ha='center')
cm.ax_heatmap.text(31.5, 17.2,drugname[4] , ha='center')
...
plt.savefig('Drug_cell_gene_connection_removeDuplicate2_DrugName.pdf')
