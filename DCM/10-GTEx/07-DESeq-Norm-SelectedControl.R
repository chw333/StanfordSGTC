...
sel = c(192, 70, 134, 360, 281, 201, 179, 142, 125, 336, 312, 350,  413, 414, 415)
Counts = Counts[1:nrow(Counts), sel]
sampleAnnot = sampleAnnot[sel,]

sampleAnnot$Tissue=c('Atrial Appendage Actual Death','Atrial Appendage Actual Death','Atrial Appendage Actual Death','Left Ventricle Actual Death','Left Ventricle Actual Death','Left Ventricle Actual Death','Atrial Appendage Presumed Death', 'Atrial Appendage Presumed Death','Atrial Appendage Presumed Death','Left Ventricle Presumed Death', 'Left Ventricle Presumed Death', 'Left Ventricle Presumed Death', 'Heart', 'Heart', 'Heart')
...
write.table(Count.norm, file="GTEx_Heart_S635A_TwoCtrl_exp-Normalized_SelectedControl.txt",quote=F,sep="\t",row.names=T,col.names=NA)
...
write.table(rlg, file="GTEx_Heart_S635A_TwoCtrl_exp-rlog_SelectedControl.txt",quote=F,sep="\t",row.names=T,col.names=NA)
