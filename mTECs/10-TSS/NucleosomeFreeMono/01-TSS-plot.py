...
Sample = ['Tspan8_negative_MHCII_low_rep1.Mono.num', 'Tspan8_negative_MHCII_low_rep2.Mono.num', 'Tspan8_negative_MHCII_high_rep1.Mono.num', 'Tspan8_negative_MHCII_high_rep2.Mono.num', 'Tspan8_positive_MHCII_low_rep1.Mono.num', 'Tspan8_positive_MHCII_low_rep2.Mono.num', 'Tspan8_positive_MHCII_high_rep1.Mono.num', 'Tspan8_positive_MHCII_high_rep2.Mono.num']
...
for i in range(len(Sample)):
    AX.append(ax.plot(range(1,MAX+1), TL[i], color=LineColor(i), linestyle='--'))
#legAX = [AX[0][0], AX[2][0], AX[4][0], AX[6][0]]
