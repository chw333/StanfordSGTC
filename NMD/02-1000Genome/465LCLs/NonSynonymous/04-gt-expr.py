...
def geno(inF):
    E,S = expr('GD462.GeneQuantRPKM.50FN.samplename.resk10.expression.NonSynonymous')
...
geno('GEUVADIS.PH1PH2_465.IMPFRQFILT_BIALLELIC_PH.annotv2.genotypes-Genotype-nonSynonymous-formated-sorted-mapped-mutationFreq')
