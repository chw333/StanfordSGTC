...
def geno(inF):
    E,S = expr('GD462.GeneQuantRPKM.50FN.samplename.resk10.expression.Synonymous')
...
geno('GEUVADIS.PH1PH2_465.IMPFRQFILT_BIALLELIC_PH.annotv2.genotypes-Genotype-synonymous-formated-sorted-mapped-mutationFreq')
